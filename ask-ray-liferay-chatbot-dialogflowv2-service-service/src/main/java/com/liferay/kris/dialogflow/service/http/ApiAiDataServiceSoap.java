 ...
 * <code>com.liferay.kris.dialogflow.model.ApiAiDataSoap</code>. If the method in the
 * service utility returns a
 * <code>com.liferay.kris.dialogflow.model.ApiAiData</code>, that is translated to a
 * <code>com.liferay.kris.dialogflow.model.ApiAiDataSoap</code>. Methods that SOAP
...
public class ApiAiDataServiceSoap {
	...
	public static com.liferay.kris.dialogflow.model.ApiAiDataSoap[]
		...
		try {
			java.util.List<com.liferay.kris.dialogflow.model.ApiAiData>
				returnValue = ApiAiDataServiceUtil.getRecentConversation(
					serviceContext, records);

			return com.liferay.kris.dialogflow.model.ApiAiDataSoap.toSoapModels(
				returnValue);
		}
		catch (Exception e) {
			_log.error(e, e);
