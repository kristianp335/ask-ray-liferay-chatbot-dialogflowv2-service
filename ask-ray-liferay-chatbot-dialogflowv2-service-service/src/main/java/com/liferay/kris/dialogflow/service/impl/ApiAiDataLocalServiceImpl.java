...
import com.liferay.kris.dialogflow.service.base.ApiAiDataLocalServiceBaseImpl;
 ...
 *
 * <p>
 * All custom service methods should be put in this class. Whenever methods are added, rerun ServiceBuilder to copy their definitions into the <code>com.liferay.kris.dialogflow.service.ApiAiDataLocalService</code> interface.
 *
 * <p>
 ...
 */
@Component(
	property = "model.class.name=com.liferay.kris.dialogflow.model.ApiAiData",
...
public class ApiAiDataLocalServiceImpl extends ApiAiDataLocalServiceBaseImpl {
	...
	public String addApiAiData(ServiceContext serviceContext,  String query, String authtoken, String speech, String action, String fulfillment, String result) {
		...
		apiAiDataResponse.setFulfillment(fulfillment);
		apiAiDataResponse.setSpeech(speech);
		apiAiDataResponse.setResult(result);
